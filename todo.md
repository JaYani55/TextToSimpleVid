02.02.25 Moviepy output works, but is non-functional. Adjust the parameters and input materials. Make sure to provide documentation for moviepy, the datasets are outdated again
